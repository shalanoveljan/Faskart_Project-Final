...
let corusels = document.querySelectorAll(".corusel");

corusels.forEach(function (corusel) {
  corusel.onmouseenter = function () {
    corusel.style.opacity = "0.5";
    setTimeout(() => {
      corusel.style.opacity = "1";
    }, 300);
  };
});
...
if (advertise != undefined) {
  advertise.onmouseenter = function () {
    console.log("sa");
    advertise.style.opacity = "0.7";
    setTimeout(() => {
      advertise.style.opacity = "1";
    }, 400);
  };
}
...
let cards = document.querySelectorAll(".elements .card");
let count = 0;
...
let buttons = document.querySelectorAll(".detail button");
